...
if(-not(($n -match "CRM Sprint 14 S14-0[2-7]") -or ($n.Contains("CRM Sprint 15 P1 - Campaign Management Functional Baseline and Backlog") -and $n.Contains("codex/prompts/sprint-15-campaign-management-p1.md") -and $n.Contains("S14-07 merge commit required")))){throw "Invalid forward handoff after S14-01"}
