...
foreach ($path in @("/health", "/health/live", "/health/ready", "/api/crm/readiness", "/api/crm/foundation/sprint-3/productization-review", "/api/crm/foundation/sprint-4/runtime-readiness", "/api/crm/foundation/sprint-4/common-db-runtime-probe")) {
    try {
