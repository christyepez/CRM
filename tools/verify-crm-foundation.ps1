...
if ($sourceText -match "HttpContext\.Request\.Headers|Request\.Headers|Headers\[|AuthorizationHeader|authorizationHeader|Bearer|localStorage|sessionStorage|HttpClient|PortalBaseUrl|PortalCorporativoUrl") {
