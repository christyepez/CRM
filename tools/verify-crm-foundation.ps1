...
if ($apiProgram -match "MapPut|MapPatch|MapDelete|CreateLead|CreateCustomer|CreateOpportunity") {
    $allowedMutationsProgram = $apiProgram.
        ...
        Replace('MapPut("/api/crm/foundation/campaigns/{id}"', '').
        ...
        Replace('MapPut("/api/crm/foundation/cases/{id}"', '').
        Replace('MapPost("/api/crm/foundation/cases"', '').
        Replace('MapPost("/api/crm/foundation/cases/{id}/start"', '').
        Replace('MapPost("/api/crm/foundation/cases/{id}/resolve"', '').
        Replace('MapPost("/api/crm/foundation/cases/{id}/close"', '').
        Replace('MapPut("/api/crm/foundation/interactions/{id}"', '').
        Replace('MapPost("/api/crm/foundation/interactions"', '').
        Replace('MapPost("/api/crm/foundation/interactions/{id}/void"', '')
...
foreach ($productiveRoute in @('"/api/crm/leads"', '"/api/crm/accounts"', '"/api/crm/contacts"', '"/api/crm/cases"')) {
    if ($apiProgram -like "*$productiveRoute*") {
        $failures += "Productive CRM endpoint found: $productiveRoute"
    }
}

foreach ($productiveRoute in @('MapGet("/api/crm/leads', 'MapGet("/api/crm/accounts', 'MapGet("/api/crm/contacts', 'MapGet("/api/crm/activities', 'MapGet("/api/crm/cases', 'MapPost("/api/crm/leads', 'MapPost("/api/crm/accounts', 'MapPost("/api/crm/contacts', 'MapPost("/api/crm/activities', 'MapPost("/api/crm/cases', 'MapPut("/api/crm/leads', 'MapPut("/api/crm/accounts', 'MapPut("/api/crm/contacts', 'MapPut("/api/crm/activities', 'MapPut("/api/crm/cases', 'MapGet("/api/crm/opportunities', 'MapPost("/api/crm/opportunities', 'MapPut("/api/crm/opportunities')) {
    if ($apiProgram -like "*$productiveRoute*") {
