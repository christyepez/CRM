...
function Remove-AllowedSprint11FrontendFoundationMarkers($Text) {
    return $Text.
        ...
        Replace("LeadQualificationApiService", "LeadQualificationFoundationApiService").
        Replace("/api/crm/foundation/leads/{leadId}/qualification", "/foundation/lead-qualification-contract").
        Replace("/crm/foundation/leads/", "/foundation/lead-qualification/")
}
...
$source = Remove-AllowedSprint11FrontendFoundationMarkers $source
...
if ((Remove-AllowedSprint11FrontendFoundationMarkers $Sprint8P4Text) -match "HttpClient\(|new HttpClient|Request\.Headers|Headers\[|AddAuthentication|UseAuthentication|UseAuthorization|AuthorizeAttribute|JwtBearer|CookieAuthentication|localStorage|sessionStorage|System\.Data\.SqlClient|Microsoft\.Data\.SqlClient|UseSqlServer\(|AddDbContext\(|MigrationBuilder") { Fail "Sprint 8 P4 must not activate Portal/Auth runtime, token/header reads, token storage, DB, EF or migrations." }
...
if ((Remove-AllowedSprint11FrontendFoundationMarkers $Sprint8P5Text) -match "HttpClient\(|new HttpClient|Request\.Headers|Headers\[|AddAuthentication|UseAuthentication|UseAuthorization|AuthorizeAttribute|JwtBearer|CookieAuthentication|localStorage|sessionStorage|System\.Data\.SqlClient|Microsoft\.Data\.SqlClient|UseSqlServer\(|AddDbContext\(|MigrationBuilder|MapDelete") { Fail "Sprint 8 P5 must not activate Portal/Auth runtime, token/header reads, token storage, DB, EF, migrations or DELETE." }
...
if ((Remove-AllowedSprint11FrontendFoundationMarkers $Sprint8P6Text) -match "HttpClient\(|new HttpClient|Request\.Headers|Headers\[|AddAuthentication|UseAuthentication|UseAuthorization|AuthorizeAttribute|JwtBearer|CookieAuthentication|localStorage|sessionStorage|System\.Data\.SqlClient|Microsoft\.Data\.SqlClient|UseSqlServer\(|AddDbContext\(|MigrationBuilder|MapDelete") { Fail "Sprint 8 P6 must not activate Portal/Auth runtime, token/header reads, token storage, DB, EF, migrations or DELETE." }
...
if ((Remove-AllowedSprint11FrontendFoundationMarkers $Sprint9P1Text) -match "HttpClient\(|new HttpClient|Request\.Headers|Headers\[|AddAuthentication|UseAuthentication|UseAuthorization|AuthorizeAttribute|JwtBearer|CookieAuthentication|localStorage|sessionStorage|System\.Data\.SqlClient|Microsoft\.Data\.SqlClient|UseSqlServer\(|AddDbContext\(|MigrationBuilder|MapDelete") { Fail "Sprint 9 P1 must not activate Portal/Auth runtime, token/header reads, token storage, DB, EF, migrations or DELETE." }
...
if ($program -notlike "*/api/crm/foundation/sprint-9/secret-provider-runtime-enablement-trial*") { Fail "Sprint 9 P2 Secret Provider trial route missing." }
$Sprint9P2Text = ""
...
if ($program -notlike "*/api/crm/foundation/sprint-9/common-db-runtime-connectivity-trial*") { Fail "Sprint 9 P3 Common DB trial route missing." }
$Sprint9P3Text = ""
...
if ($program -notlike "*/api/crm/foundation/sprint-9/portal-auth-runtime-validation-trial*") { Fail "Sprint 9 P4 Portal Auth trial route missing." }
$Sprint9P4Text = ""
...
$Sprint9P4ScanText = (Remove-AllowedSprint11FrontendFoundationMarkers $Sprint9P4Text).Replace("AuthAttributeEnabled", "").Replace("AuthHeaderRead", "")
...
$Sprint9P5ScanText = (Remove-AllowedSprint11FrontendFoundationMarkers $Sprint9P5Text).Replace("AuthAttributeEnabled", "").Replace("AuthHeaderRead", "")
...
if ($program -notlike "*/api/crm/foundation/sprint-9/gate-decision*") { Fail "Sprint 9 P6 gate decision route missing." }
if ($program -like "*/api/crm/foundation/sprint-9/gate-decision/probe*") { Fail "Sprint 9 P6 must remain GET-only and must not add a probe route." }
$Sprint9P6Text = ""
...
if ($Program -notmatch [regex]::Escape('/api/crm/foundation/sprint-10/productization-readiness-decision')) { Fail "Missing Sprint 10 P1 productization readiness endpoint." }
if ($Program -match [regex]::Escape('/api/crm/foundation/sprint-10/productization-readiness-decision/probe')) { Fail "Sprint 10 P1 must not add a POST probe endpoint." }
$Sprint10P1Text = ""
