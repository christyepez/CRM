...
$s16=( ($next -match 'CRM Sprint 16 S16-0[3-7]') -and ($next -match 'codex/prompts/sprint-16-account-management-s16-0[3-7]\\.md') ); $s17=$next.Contains('CRM Sprint 17 P1 - Segment Management Functional Baseline and Backlog') -and $next.Contains('codex/prompts/sprint-17-segment-management-p1.md'); if(-not($s16 -or $s17)){throw 'Invalid Sprint 16 S16-02 forward handoff.'}
