...
if(-not(($next -match 'CRM Sprint 16 S16-0[2-7]') -and ($next -match 'codex/prompts/sprint-16-account-management-s16-0[2-7]\.md'))){throw 'Invalid Sprint 16 S16-01 forward handoff.'}
