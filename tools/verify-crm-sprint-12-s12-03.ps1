...
if (-not $nextTask.Contains("CRM Sprint 12 S12-04 - Contact Management Frontend Foundation Page")) {
    throw "codex/next-task.md must point to S12-04."
}

if (-not $nextTask.Contains("codex/prompts/sprint-12-contact-management-s12-04.md")) {
    throw "codex/next-task.md must reference the S12-04 prompt."
}
