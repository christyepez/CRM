...
if(-not($next.Contains('CRM Sprint 15 S15-02 - Campaign Application Service and Foundation Store') -and $next.Contains('codex/prompts/sprint-15-campaign-management-s15-02.md') -and $next.Contains('S15-01 merge commit required'))){throw 'Invalid S15-02 handoff'}
