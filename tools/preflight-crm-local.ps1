...
if ($programText -like "*/api/crm/foundation/sprint-9/controlled-runtime-activation-decision*") { Pass "Sprint 9 P1 controlled runtime activation decision endpoint registered." } else { Fail "Sprint 9 P1 endpoint missing." }
$Sprint9P1Text = ""
...
foreach ($Sprint9P1Marker in @("ControlledRuntimeActivationDecision", "ApprovedForNonProductionTrialsOnly", "ProductionActivationDecision", "NoGo", "RuntimeTrialsEnabledNow: false", "ProductionRuntimeEnabledNow: false", "SecretProviderRuntimeEnabledNow: false", "CommonDbRuntimeEnabledNow: false", "PortalAuthRuntimeEnabledNow: false", "ProductiveRoutesEnabledNow: false", "ProductiveCrudEnabledNow: false", "DeleteEnabledNow: false", "ProductiveUiEnabledNow: false", "Sprint9P2SecretProviderRuntimeEnablementTrial", "Sprint 9 P1 is an approval decision only; no runtime trial is enabled now", "Sprint 9 P1 Controlled Runtime Activation Decision: Exists")) {
...
if ($programText -like "*/api/crm/foundation/sprint-9/productive-route-dry-run-trial*") { Pass "Sprint 9 P5 Productive Route dry-run endpoint registered." } else { Fail "Sprint 9 P5 endpoint missing." }
$Sprint9P5Text = ""
