...
public static class ReportingInsightKeys { public const string LeadsFunnel="leads-funnel";  public const string OpportunitiesPipeline="opportunities-pipeline";  public const string SalesActivities="sales-activities";  public const string AccountsContacts="accounts-contacts";  public const string CrmExecutiveOverview="crm-executive-overview"; }