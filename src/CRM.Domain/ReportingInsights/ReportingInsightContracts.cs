...
public static class ReportingInsightKeys { public const string LeadsFunnel="leads-funnel";  public const string OpportunitiesPipeline="opportunities-pipeline"; }