...
## Runbook
Validate docs, endpoint, service and placeholder. Confirm disabled flags. Run preflight, guardrails, health and E2E foundation checks. Do not configure Portal runtime.
