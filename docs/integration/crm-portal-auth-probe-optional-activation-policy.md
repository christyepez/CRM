...
## Policy
Activation requires non-production approval, secret provider runtime approval, token propagation approval, correlation ID strategy and rollback evidence. No Portal URL may be hardcoded.
